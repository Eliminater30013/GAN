...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--generator', type=str, default='resnet_6blocks', help='generator model to produce lstm input')
        ...
        parser.add_argument('--model', type=str, default='pix2pix',
                            help='chooses which model to use. cycle_gan, pix2pix, test, or nogan')
