...
if __name__ == '__main__':
    ...
    run('python train.py --model train --dataroot ./datasets/mini --name horse2zebra_pretrained --no_dropout --how_many 1')
    ...
    run('python train.py --dataroot ./datasets/facades/ --which_direction BtoA --model pix2pix --name facades_label2photo_pretrained --how_many 1')

    # cyclegan train/train
    run('python train.py --name temp --dataroot ./datasets/mini --niter 1 --niter_decay 0 --save_latest_freq 10  --print_freq 1 --display_id -1')
    run('python train.py --name temp --dataroot ./datasets/mini --how_many 1 --model_suffix "_A"')
    ...
    run('python train.py --model pix2pix --name temp --dataroot ./datasets/mini_pix2pix --how_many 1 --which_direction BtoA')
